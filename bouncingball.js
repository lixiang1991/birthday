...
requestAnimationFrame(loop = function () {
    ...
    for (var i in fireballs) {
        switch (i % 8) {
            ...
            case 2: particleColor = 'Blue'; break; //'#fff'
            case 3: particleColor = 'White'; break;
            case 4: particleColor = 'Green'; break;
            case 5: particleColor = 'Gray'; break;
            case 6: particleColor = 'Brown'; break;
            case 7: particleColor = 'Orange'; break;
        }
        f = fireballs[i];
		...
		f.life--;
        if (f.life < 0) delete fireballs[f.index]; //--f.life,??????????
    }
